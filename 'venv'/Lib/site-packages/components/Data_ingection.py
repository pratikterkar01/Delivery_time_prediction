...
class Dataingection:
    ...
    def initiate_data_ingection(self):
        ...
        try:
            ...
            train_set.read_csv(self.ingection_config.train_data_path,index=False,header=True)
            test_set.read_csv(self.ingection_config.train_data_path,index=False,header=True)
